  ...
  public partial class StockList
  {
    ...
    public void SortByValue()
    {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    if (list[sort].StockHolding.Holdings < list[sort + 1].StockHolding.Holdings)
                    {
                        temp = list[sort + 1];
            ...
            for (int i = 0; i < list.Count; i++)
            {
                var symbol = list[i].StockHolding.Symbol;
                var name = list[i].StockHolding.Name;
                var holdings = list[i].StockHolding.Holdings;
                var currentPrice = list[i].StockHolding.CurrentPrice;
